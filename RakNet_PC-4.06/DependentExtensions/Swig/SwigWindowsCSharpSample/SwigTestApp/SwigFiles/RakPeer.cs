...
public class RakPeer : RakPeerInterface {
  ...
  public override bool RunRecvFromOnce(int s, ushort remotePortRakNetWasStartedOn_PS3, uint extraSocketOptions) {
    bool ret = RakNetPINVOKE.RakPeer_RunRecvFromOnce(swigCPtr, s, remotePortRakNetWasStartedOn_PS3, extraSocketOptions);
    return ret;
  }
  ...
  public void ProcessChromePacket(int s, string buffer, int dataSize, SystemAddress recvFromAddress, ulong timeRead) {
    RakNetPINVOKE.RakPeer_ProcessChromePacket(swigCPtr, s, buffer, dataSize, SystemAddress.getCPtr(recvFromAddress), timeRead);
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }
