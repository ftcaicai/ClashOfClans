...
public class RakPeerInterface : IDisposable {
  ...
  public virtual bool RunRecvFromOnce(int s, ushort remotePortRakNetWasStartedOn_PS3, uint extraSocketOptions) {
    bool ret = RakNetPINVOKE.RakPeerInterface_RunRecvFromOnce(swigCPtr, s, remotePortRakNetWasStartedOn_PS3, extraSocketOptions);
    return ret;
  }
