...
public class RakNetSocket : IDisposable {
  ...
  public int s {
    ...
    get {
      int ret = RakNetPINVOKE.RakNetSocket_s_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public bool blockingSocket {
    set {
      RakNetPINVOKE.RakNetSocket_blockingSocket_set(swigCPtr, value);
    } 
    get {
      bool ret = RakNetPINVOKE.RakNetSocket_blockingSocket_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public int chromeInstance {
    set {
      RakNetPINVOKE.RakNetSocket_chromeInstance_set(swigCPtr, value);
    } 
    get {
      int ret = RakNetPINVOKE.RakNetSocket_chromeInstance_get(swigCPtr);
      return ret;
    } 
  }
